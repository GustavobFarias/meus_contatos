...
import { editar, remover, alteraStatus } from '../../store/reducers/contato'
  ...
  return (
    <S.Card>
      ...
      <S.contas
        ...
        value={telefoneState}
        onChange={(evento) => setTelefoneState(evento.target.value)}
      />
      <S.contas
        disabled={!estaEditando}
        value={emailState}
        onChange={(evento) => setEmailState(evento.target.value)}
      />
      <S.BarraAcoes>
        {estaEditando ? (
          <>
              ...
              onClick={() => {
                dispatch(
                  editar({
                    ...
                    email: emailState, // Usando o estado atualizado de email
                    prioridade,
                    status,
                    titulo,
                    id
